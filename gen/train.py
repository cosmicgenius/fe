...
from config import models_path, train_fe_path, val_fe_path, meta_fe_path, parse_args, TrainConfig, train_configs
...
def main():
    ...
    train(config, train_fe_path, val_fe_path, meta_fe_path, models_path)
